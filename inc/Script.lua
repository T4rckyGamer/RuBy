...
return sendMsg(arg.ChatID,arg.MsgID,"⚜️*¦* لا يمكنك تقييد مطور البوت \n📛") 
...
elseif UserID == "909279851 " or UserID == "909279851 " then 
return sendMsg(msg.chat_id_,msg.id_,"⚜️*¦* لا يمكنك تقييد مطور البوت\n🛠") 
...
elseif UserID == 909279851 or UserID == 909279851 then 
return sendMsg(arg.ChatID,arg.MsgID,"⚜️*¦* لا يمكنك طرد مطور البوت \n🛠") 
elseif UserID == SUDO_ID then 
...
elseif UserID == 909279851 or UserID == 909279851 then 
return sendMsg(arg.ChatID,arg.MsgID,"⚜️*¦* لا يمكنك حظر مطور البوت \n🛠") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
elseif UserID == 909279851 or UserID == 909279851 then 
return sendMsg(arg.ChatID,arg.MsgID,"⚜️*¦* لا يمكنك كتم مطور البوت \n🛠") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
if UserID == 909279851 or UserID == 909279851 then return sendMsg(msg.chat_id_,msg.id_,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور البوت \n❕") end
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع بوتك يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
🔅¦ اضف رد : لاضافه رد خاص
🔅¦ مسح رد : الرد المراد حذفه
🔅¦ مسح الردود : لحذف كل الردود
🔅¦ اوامر الردود : لشرح مفصل

🕹¦ اوامر الردود للمطور الأساسي ⇊
🔅¦ اضف رد عام 
🔅¦ مسح رد عام  
🔅¦ مسح الردود العامه 
🔅¦ـ➖➖➖➖➖
...
sendMsg(msg.chat_id_,msg.id_,'تم المغادره بأمر من المطور') 
rem_data_group(msg.chat_id_)
