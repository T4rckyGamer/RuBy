...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://github.com/T4rckyGamer/Rubys/master/GetVersion.txt' ) or 0
...
📟¦ م2 » اوامر الاعدادات 
🛡¦ م3 » اوامر الحمايه
⚡️¦ الحمايه » مقفل أو مفتوح
⚡️¦ الاعدادات » حالة الاوامر 
⚡️¦ اوامر الرد » لاضافة الردود 
...
if not msg.Kara then return "📪¦ هذا الامر يخص {منشئ اساسي,المطور} فقط  \n" end

if not msg.kara and msg.reply_id then 
GetMsgInfo(msg.chat_id_,msg.reply_id,function(arg,data)
...
redis:hset(clay..'username:'..UserID,'username',arg.USERNAME)
redis:setex(clay..":uploadingsomeon:"..arg.ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(clay..":uploadingsomeon2:"..arg.ChatID..msg.sender_user_id_,500,UserID)
