...
download_file('https://raw.githubusercontent.com/T4rckyGamer/Rubys/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/T4rckyGamer/Rubys/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/T4rckyGamer/Rubys/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/T4rckyGamer/Rubys/master/inc/functions.lua','./inc/functions.lua')
...
message = message ..i.. '-l ['..info.username..'](t.me/YaqotSa1) \n'
end
...
elseif UserID == 909279851 or UserID == 909279851 then 
return sendMsg(ChatID,MsgID,"⚜️*¦* لا يمكنك طرد مطور الاساسي\n🛠") 
elseif redis:sismember(boss..':SUDO_BOT:',UserID) then 
...
if UserID == 909279851 or UserID == 909279851 then return sendMsg(ChatID,MsgID,"📛*¦* لآ يمكنك تنفيذ الامر ضد مطور السورس \n❕") end
